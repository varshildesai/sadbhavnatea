...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400 relative z-10">
